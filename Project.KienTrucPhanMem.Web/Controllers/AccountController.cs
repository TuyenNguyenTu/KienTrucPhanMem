...
using Project.KienTrucPhanMem.Sessions;
using Project.KienTrucPhanMem.Web.Controllers.Results;
using Project.KienTrucPhanMem.Web.Models;
using Project.KienTrucPhanMem.Web.Models.Account;
...
{
    public class AccountController : KienTrucPhanMemControllerBase
    {
